...
OUTPUT_DIR = 'nips-plots/traditional/' # add '/' at the end

if not os.path.exists(OUTPUT_DIR):
   os.makedirs(OUTPUT_DIR)

# Set csv paths
csv_traditional = 'traditionalRL-merged.csv'
csv_byol = 'BYOL-merged.csv'

# Read csv files
df_traditional = pd.read_csv(csv_traditional, sep=',')
df_byol = pd.read_csv(csv_byol, sep=',')

# Create a dictionary to store dfs with their correct name
dict_df = {
    'traditionalRL': df_traditional,
    'BYOL': df_byol
}
